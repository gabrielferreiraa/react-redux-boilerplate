          ...
          <div className='card-block'>
            <div className='row'>
              ...
              <div className='col-sm-7 hidden-sm-down'>
                <button type='button' className='btn btn-primary float-right'><i className='icon-cloud-download' /></button>
                ...
                <div className='row'>
                  <div className='col-sm-12 col-lg-4'>
                    ...
                    <ul className='horizontal-bars'>
                      ...
                      <li className='legend'>
                        <span className='badge badge-pill badge-info' /> <small>New clients</small> &nbsp; <span className='badge badge-pill badge-danger' /> <small>Recurring clients</small>
                      </li>
                    </ul>
                  </div>
                  <div className='col-sm-6 col-lg-4'>
                    ...
                    <ul className='horizontal-bars type-2'>
                      ...
                      <li className='divider text-center'>
                        <button type='button' className='btn btn-sm btn-link text-muted' data-toggle='tooltip' data-placement='top' title='' data-original-title='show more'><i className='icon-options' /></button>
                      </li>
                    </ul>
                  </div>
                  <div className='col-sm-6 col-lg-4'>
                    ...
                    <ul className='icons-list'>
                      <li>
                        ...
                        <div className='actions'>
                          <button type='button' className='btn btn-link text-muted'><i className='icon-settings' /></button>
                        </div>
                      </li>
                      <li>
                      ...
                      <li className='divider text-center'>
                        <button type='button' className='btn btn-sm btn-link text-muted' data-toggle='tooltip' data-placement='top' title='show more'><i className='icon-options' /></button>
                      </li>
                    </ul>
                  </div>
                </div>
